        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowStockAlertedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_Discount_DiscountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefundRequest_AspNetUsers_ReviewedById",
                        column: x => x.ReviewedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RefundRequest_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ProductOptionValues_Id_OptionId", x => new { x.Id, x.OptionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PurchasedVariantId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_ProductVariants_PurchasedVariantId",
                        column: x => x.PurchasedVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WishlistItem_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VariantOptions_ProductOptionValues_OptionValueId_OptionId",
                        columns: x => new { x.OptionValueId, x.OptionId },
                        principalTable: "ProductOptionValues",
                        principalColumns: new[] { "Id", "OptionId" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VariantOptions_ProductOptions_OptionId",
                        column: x => x.OptionId,
                        principalTable: "ProductOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundRequest_ReviewedById",
                table: "RefundRequest",
                column: "ReviewedById");

            migrationBuilder.CreateIndex(
                name: "IX_RefundRequest_UserId_Status",
                table: "RefundRequest",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_PurchasedVariantId",
                table: "Reviews",
                column: "PurchasedVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VariantOptions_OptionId",
                table: "VariantOptions",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_VariantOptions_OptionValueId_OptionId",
                table: "VariantOptions",
                columns: new[] { "OptionValueId", "OptionId" });

            migrationBuilder.CreateIndex(
                name: "IX_VariantOptions_VariantId_OptionId",
                table: "VariantOptions",
                columns: new[] { "VariantId", "OptionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VariantOptions_VariantId_OptionValueId",
                table: "VariantOptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistItem_ProductVariantId",
                table: "WishlistItem",
                column: "ProductVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItem_WishlistId_ProductVariantId",
                table: "WishlistItem",
